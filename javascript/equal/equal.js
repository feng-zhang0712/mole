function isEqual(a, b, visited = new WeakMap()) {
  ...
  switch (typeA) {
    ...
    case '[object Object]':
      ...
      return  keysA.every((key, index) => isEqual(a[key], b[keysB[index]], visited));
    ...
    case '[object Set]':
      ...
      return valuesA.every(value => b.has(value) && isEqual(value, value, visited));
    case '[object Map]':
      const entriesA = Array.from(a.entries());
      return entriesA.every(([key, value]) => b.has(key) && isEqual(value, b.get(key), visited));
    default:
