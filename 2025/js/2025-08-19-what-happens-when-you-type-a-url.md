...
![用三报文握手建立 TCP 连接](../computer/computer-network/assets/a-three-packet-handshake-is-used-to-establish-a-tcp-connection.png)
...
![TCP 连接释放的过程](../computer/computer-network/assets/the-process-of-releasing-the-tcp-connection.png)
