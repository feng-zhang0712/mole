...
8. I'd document and report the incident to my supervisor and share with the authorized colleagues to keep them informed to prevent this kind of incident in the future if necessary.
...
5. I'd document the request in the client's records.
6. I'd continue to provide care within my role, ensuring the client feels supported and respected while their request is addressed appropriately.

### Handle Refusal

1. I'd stay calm and respect the client’s right to make choices.
2. I'd ask gentle questions to find out why they’re refusing, sometimes refusal means something wrong with their physical or mental health, or event the care we provided.
...
7. If the refusal impacts their safety or health, I'd document and report it to my supervisor, and maybe share with the authorized colleagues to keep them informed if necessary.
...
1. **Ensure Client Safety**: I'd make sure the client is safe. If there’s immediate danger, I'd take appropriate action, such as removing the client from harm.
2. **Observe and Identify Signs**: I'd carefully observe any physical, emotional, or behavioral signs of abuse or neglect, ensuring I have clear and accurate details without jumping to conclusions.
...
5. **Support the Client**: I'd offer emotional support to the client, listening to their concerns and ensuring they feel safe and respected.
6. **Follow Up**: I'd check in with my supervisor to ensure the issue is being addressed and offer any further assistance needed to support the client’s well-being.
...
1. **Review Care Plan**: I review the client’s care plan to understand their specific communication challenges, such as dementia or speech difficulties.
2. **Use Simple Language**: I speak slowly and clearly, using short and simple sentences to make it easy for clients to understand.
3. **Use Body Language**: I use body language, facial expressions, eye contact to support clients with hearing loss or cognitive challenges.
4. **Use Visual Aids**: I use pictures, notes, or communication boards to support clients with speech or hearing difficulties.
5. **Be Patient**: I give clients time to respond and reduce stress.
...
Home care supports clients in their own homes, helping them stay independent for as long as possible. Clients usually have lower to moderate care needs. As a support worker, tasks often include:
...
In home care, support workers usually support one client at a time, and care is based on the client’s needs and routines.

**Residential Aged Care** / **Nursing Home Care**

Residential aged care is provided in a facility, like nursing home, for people with higher or complex care needs who can no longer live safely at home. Clients may need:

- 24/7 supervision
- Assistance with most ADLs
- Work closely within a multidisciplinary team (clinical care from nurses)

Support workers in residential aged care often work as part of a larger team, supporting multiple residents during a shift and following care plans and safety procedures.

**Summary**

In short, home care focuses on independence and support in the client’s own home, while residential aged care provides higher-level, continuous care in a facility. In both settings, the goal is the same: to ensure safety, health, wellbeing, and quality of life through person-centred care.
...
- D (DEFIBRILLATION): Apply an AED and follow its voice prompts as soon as possible. 
...
- What kind of support or training do you provide for a new staff?
